...
def get_log_color(value, min_value, max_value):
    """
    Cette fonction renvoie une couleur basée sur la valeur donnée.
    Utilise une échelle logarithmique pour une meilleure répartition des couleurs.
    """
    # Ajout de 1 pour éviter les problèmes de log(0)
    ...
    # Conversion en une couleur allant du vert (faible consommation) au rouge (forte consommation)
...
def show_data_analysis():
    ...
    # Sélectionner les options pour le menu déroulant
    col1, col2, col3 = st.columns([2, 2, 2])  # Utilisation de st.columns pour diviser l'espace
    ...
    with col3:
        neighborhoods = df['Neighborhood'].unique()  # Remplacez 'Neighborhood' par la colonne correcte
    ...
    with col5:
        ...
        # Récupérer les valeurs minimales et maximales de la consommation énergétique
    ...
    with col8:
        # Calcul de la distribution du totalGFA
